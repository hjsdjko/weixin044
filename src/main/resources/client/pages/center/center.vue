	...
	<view class="content">
		<view :style='{"width":"100%","padding":"0 0 120rpx","position":"relative","background":"#f4f4f4","height":"auto"}'>
			<view v-if="user&&user.id" :style='{"padding":"0 24rpx 0 24rpx","margin":"0px 0 20rpx 0","borderRadius":"0 0 60rpx 60rpx","background":"#1D5DCA","display":"flex","width":"100%","height":"280rpx"}' class="header" v-bind:class="{'status':isH5Plus}" @tap="onPageTap2('../user-info/user-info',1)">
				<view :style='{"width":"calc(100% - 112rpx)","alignItems":"center","display":"flex","height":"100%"}' v-if="tableName=='yonghu'" class="userinfo">
					...
					<view :style='{"width":"100%","flex":"1","flexDirection":"column","justifyContent":"center","display":"flex","height":"100%"}' class="info">
						<view :style='{"width":"100%","lineHeight":"36rpx","fontSize":"28rpx","color":"#ffffff"}'>{{user.zhanghao}}<text v-if="user.vip&& user.vip=='是'">(VIP)</text></view>
						<view :style='{"width":"100%","lineHeight":"36rpx","fontSize":"28rpx","color":"#ffffff"}' v-if="user.money">余额：{{user.money}}</view>
						<view :style='{"width":"100%","lineHeight":"36rpx","fontSize":"28rpx","color":"#ffffff"}' v-if="user.jf||user.jf==0">积分：{{user.jf}}</view>
					</view>
				</view>
			...
			<view :style='{"padding":"0px 20rpx 40rpx 20rpx","margin":"40rpx 40rpx 120rpx 40rpx","borderRadius":"8rpx","flexWrap":"wrap","background":"#ffffff","display":"flex","width":"calc(100% - 80rpx)","justifyContent":"space-between","height":"auto"}' class="list">
				...
				<view v-if="user&&user.id" @tap="onPageTap2('../shop-recharge/pay-confirm')" :style='{"border":"0px solid #6fcbcb60","padding":"0px 0px","margin":"0 0 0px 0","borderColor":"#eeeeee","alignItems":"center","textAlign":"center","display":"flex","transition":"all 0s","borderRadius":"0px","flexWrap":"wrap","background":"#ffffff","borderWidth":"0 0 2rpx 0","width":"100%","position":"relative","borderStyle":"solid","height":"92rpx"}' class="li" hover-class="hover">
