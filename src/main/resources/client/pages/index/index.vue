	...
	<view :style='{"width":"100%","flexWrap":"wrap","background":"#ffffff","display":"flex","height":"100%"}'>
		...
		<!-- 商品列表 -->
			...
			<view class="title" :style='{"padding":"0 32rpx 0 32rpx","margin":"0 24rpx 24rpx 24rpx","borderColor":"#1d5dca","borderWidth":"0 0 0 8rpx","display":"flex","width":"calc(100% - 48rpx)","borderStyle":"solid","justifyContent":"space-between","height":"48rpx"}'>
				<view :style='{"fontSize":"36rpx","lineHeight":"48rpx","color":"#333333","fontWeight":"600"}'>商品信息</view>
				<text :style='{"color":"#666","fontSize":"28rpx","lineHeight":"48rpx"}' @tap="onPageTap('shangpinxinxi')">查看更多</text>
			</view>
			...
			<view v-if="false && 3 == 2" class="idea listIdea" :style='{"width":"100%","padding":"40rpx","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20230815/1b3e2caf374142fcb4d5bdb9448d4e01.png) no-repeat center bottom / cover","display":"block","height":"360rpx"}'>
				...
				<view :style='{"width":"20%","background":"#ffffff","display":"none","height":"160rpx"}' class="box box4"></view>
		  		  ...
		  		  <!-- 样式3 -->
		  <view v-if="3 == 3" class="list-box style3" :style='{"width":"100%","padding":"24rpx 24rpx 24rpx 24rpx","margin":"0 0 0 0","height":"auto"}'>
			<view @tap="onDetailTap('shangpinxinxi',product.id)" v-for="(product,index) in homeshangpinxinxilist" :key="index" class="list-item" :style='{"boxShadow":"0 0px 0px #00000030","padding":"0 0 20rpx 0","margin":"0 0 40rpx 0","borderColor":"#eeeeee","flexWrap":"wrap","borderWidth":"0 0 2rpx 0","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"space-between","height":"auto"}'>
			  			  			  			  			  			  			  			  			  			  			  			  			  <image :style='{"width":"200rpx","margin":"0 20rpx 0 0","objectFit":"cover","borderRadius":"8rpx","display":"block","height":"200rpx"}' class="list-item-image" mode="aspectFill" v-if="product.shangpintupian.substring(0,4)=='http'" :src="product.shangpintupian"></image>
			  <image :style='{"width":"200rpx","margin":"0 20rpx 0 0","objectFit":"cover","borderRadius":"8rpx","display":"block","height":"200rpx"}' class="list-item-image" mode="aspectFill" v-else :src="product.shangpintupian?baseUrl+product.shangpintupian.split(',')[0]:''"></image>
			  			  			  			  			  			  			  			  			  			  			  			  			  <view class="list-item-body" :style='{"width":"calc(100% - 240rpx)","padding":"0 0 0 0","margin":"20rpx 0 0 0","height":"auto"}'>
				                				                				<view :style='{"padding":"0 20rpx 0 20rpx","margin":"0 0 12rpx","overflow":"hidden","whiteSpace":"nowrap","color":"#333333","borderRadius":"8rpx","background":"#ffffff","width":"100%","lineHeight":"60rpx","fontSize":"28rpx","textOverflow":"ellipsis","height":"60rpx"}' class="list-item-title">{{product.shangpinbiaoti}}</view>
								                				                				                				                				                				                				                				                				                																																																																																<view :style='{"padding":"0 20rpx 0 20rpx","margin":"0 0 0 0","color":"#2f72e3","textAlign":"left","width":"100%","lineHeight":"60rpx","fontSize":"28rpx"}' class="list-item-pirce">￥{{product.price}}</view>
																											  </view>
			</view>
		  </view>
